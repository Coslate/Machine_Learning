...
def main():
    ...
    (infile_train_label, infile_train_image, use_color, is_debug) = ArgumentParser()
    ...
    (all_ximage_storing, all_disximage_storing, all_xindex_storing) = StoreClassify(train_y, train_x, is_debug, rows, cols)
...
def ArgumentParser():
    ...
    return (infile_train_label, infile_train_image, use_color, is_debug)
